...
namespace UnityEngine.InputSystem.Samples.RebindUI
{
    ...
    public class GamepadIconsExample : MonoBehaviour
    {
        ...
        public struct GamepadIcons
        {
            ...
            public Sprite rightRightStick;
            public Sprite leftRightStick;
            public Sprite rightLeftStick;
            public Sprite leftLeftStick;
            ...
            public Sprite GetSprite(string controlPath)
            {
                ...
                switch (controlPath)
                {
                    ...
                    case "leftStick/left": return leftLeftStick;
                    case "leftStick/right": return rightLeftStick;
                    case "rightStick/leftt": return leftRightStick;
                    case "rightStick/right": return rightRightStick;
